...
urlpatterns = [
    ...
    path('password_reset/', auth_views.PasswordResetView.as_view(template_name='todo/registration/password_reset_form.html', email_template_name='todo/registration/password_reset_email.html',success_url=reverse_lazy('todo:password_reset_done')), name='password_reset'),
    ...
    path('reset/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name='todo/registration/password_reset_confirm.html', success_url=reverse_lazy('todo:password_reset_complete')), name='password_reset_confirm'),
